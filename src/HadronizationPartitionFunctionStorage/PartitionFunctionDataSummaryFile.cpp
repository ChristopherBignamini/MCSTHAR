...
void MassGridDataElement::
dataFileName (::std::unique_ptr< dataFileName_type > x)
{
  this->dataFileName_.set (std::move (x));
}
...
void PartitionFunctionDataSummaryFile::
massGridDataElementList (::std::unique_ptr< massGridDataElementList_type > x)
{
  this->massGridDataElementList_.set (std::move (x));
}
...
: ::xml_schema::type (),
  ...
  dataFileName_ (dataFileName, this)
{
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< dataFileName_type > r (
        dataFileName_traits::create (i, f, this));

      if (!dataFileName_.present ())
      {
        this->dataFileName_.set (::std::move (r));
        continue;
      }
    }
...
operator= (const MassGridDataElement& x)
{
  if (this != &x)
  {
    ...
    this->dataFileName_ = x.dataFileName_;
  }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< massGridDataElement_type > r (
        massGridDataElement_traits::create (i, f, this));

      this->massGridDataElement_.push_back (::std::move (r));
      continue;
    }
...
operator= (const MassGridDataElementList& x)
{
  ...
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->massGridDataElement_ = x.massGridDataElement_;
...
: ::xml_schema::type (),
  ...
  massGridDataElementList_ (massGridDataElementList, this)
{
}

PartitionFunctionDataSummaryFile::
PartitionFunctionDataSummaryFile (::std::unique_ptr< chargeConfiguration_type > chargeConfiguration,
                                  ::std::unique_ptr< massGridDataElementList_type > massGridDataElementList)
: ::xml_schema::type (),
  chargeConfiguration_ (std::move (chargeConfiguration), this),
  massGridDataElementList_ (std::move (massGridDataElementList), this)
{
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< massGridDataElementList_type > r (
        massGridDataElementList_traits::create (i, f, this));

      if (!massGridDataElementList_.present ())
      {
        this->massGridDataElementList_.set (::std::move (r));
        continue;
      }
    }
...
operator= (const PartitionFunctionDataSummaryFile& x)
{
  if (this != &x)
  {
    ...
    this->massGridDataElementList_ = x.massGridDataElementList_;
  }
                                   ...
                                   const ::xml_schema::properties& p)
{
  ...
  return ::std::unique_ptr< ::PartitionFunctionDataSummaryFile > (
...
::std::unique_ptr< ::PartitionFunctionDataSummaryFile >
PartitionFunctionDataSummaryFile_ (const ::xercesc::DOMDocument& doc,
                                   ::xml_schema::flags f,
                                   const ::xml_schema::properties& p)
{
  ...
  if (n.name () == "PartitionFunctionDataSummaryFile" &&
      n.namespace_ () == "")
  {
    ::std::unique_ptr< ::PartitionFunctionDataSummaryFile > r (
...
operator<< (::xercesc::DOMElement& e, const MassGridDataElementList& i)
{
  ...
  for (MassGridDataElementList::massGridDataElement_const_iterator
       ...
       b != n; ++b)
  {
    const MassGridDataElementList::massGridDataElement_type& x (*b);
