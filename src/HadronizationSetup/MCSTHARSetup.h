...
#ifndef MCSTHARSETUP_HXX
#define MCSTHARSETUP_HXX
...
class MCSTHARSetup: public ::xml_schema::type
{
  ...
  void
  partitionFunctionDataSetPath (::std::unique_ptr< partitionFunctionDataSetPath_type > p);
...
void
MCSTHARSetup_ (::std::ostream& os,
               const ::MCSTHARSetup& x, 
...
void
MCSTHARSetup_ (::xercesc::XMLFormatTarget& ft,
               const ::MCSTHARSetup& x, 
               const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
               const ::std::string& e = "UTF-8",
               ::xml_schema::flags f = 0);
...
MCSTHARSetup_ (const ::MCSTHARSetup& x, 
               const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
               ::xml_schema::flags f = 0);

void
operator<< (::xercesc::DOMElement&, const MCSTHARSetup&);
