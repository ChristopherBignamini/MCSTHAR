...
#ifndef PARTITION_FUNCTION_DATA_SUMMARY_FILE_H
#define PARTITION_FUNCTION_DATA_SUMMARY_FILE_H
...
class MassGridDataElement: public ::xml_schema::type
{
  ...
  void
  dataFileName (::std::auto_ptr< dataFileName_type > p);
...
class PartitionFunctionDataSummaryFile: public ::xml_schema::type
{
  ...
  void
  massGridDataElementList (::std::auto_ptr< massGridDataElementList_type > p);
  ...
  PartitionFunctionDataSummaryFile (::std::auto_ptr< chargeConfiguration_type >&,
                                    ::std::auto_ptr< massGridDataElementList_type >&);
...
#endif // PARTITION_FUNCTION_DATA_SUMMARY_FILE_H
