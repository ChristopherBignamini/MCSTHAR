...
void PartitionFunctionGridElement::
importanceSamplingFunctionParameters (::std::auto_ptr< importanceSamplingFunctionParameters_type > x)
{
  this->importanceSamplingFunctionParameters_.set (x);
}
...
void PartitionFunctionDataFile::
partitionFunctionDataList (::std::auto_ptr< partitionFunctionDataList_type > x)
{
  this->partitionFunctionDataList_.set (x);
}
...
: ::xml_schema::type (),
  electricChargeFugacity_ (electricChargeFugacity, ::xml_schema::flags (), this),
  baryonicChargeFugacity_ (baryonicChargeFugacity, ::xml_schema::flags (), this),
  strangeChargeFugacity_ (strangeChargeFugacity, ::xml_schema::flags (), this),
  charmChargeFugacity_ (charmChargeFugacity, ::xml_schema::flags (), this),
  bottomChargeFugacity_ (bottomChargeFugacity, ::xml_schema::flags (), this),
...
: ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
  electricChargeFugacity_ (f, this),
  baryonicChargeFugacity_ (f, this),
  strangeChargeFugacity_ (f, this),
  charmChargeFugacity_ (f, this),
  bottomChargeFugacity_ (f, this),
  temperature_ (f, this)
{
...
: ::xml_schema::type (),
  partitionFunctionGridElementIndex_ (partitionFunctionGridElementIndex, ::xml_schema::flags (), this),
  partitionFunctionValue_ (partitionFunctionValue, ::xml_schema::flags (), this),
  partitionFunctionErrorValue_ (partitionFunctionErrorValue, ::xml_schema::flags (), this),
  numberChannelSamplings_ (numberChannelSamplings, ::xml_schema::flags (), this),
  importanceSamplingFunctionParameters_ (::xml_schema::flags (), this)
{
}
...
PartitionFunctionGridElement (const ::xercesc::DOMElement& e,
                              ...
                              ::xml_schema::container* c)
: ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
  partitionFunctionGridElementIndex_ (f, this),
  partitionFunctionValue_ (f, this),
  partitionFunctionErrorValue_ (f, this),
  numberChannelSamplings_ (f, this),
  importanceSamplingFunctionParameters_ (f, this)
{
  if ((f & ::xml_schema::flags::base) == 0)
  {
    ::xsd::cxx::xml::dom::parser< char > p (e, true, false);
       ...
       ::xml_schema::flags f)
{
  for (; p.more_elements (); p.next_element ())
  {
    ...
    {
      ::std::auto_ptr< importanceSamplingFunctionParameters_type > r (
        importanceSamplingFunctionParameters_traits::create (i, f, this));

      if (!this->importanceSamplingFunctionParameters_)
      {
        this->importanceSamplingFunctionParameters_.set (r);
        continue;
      }
    }
...
: ::xml_schema::type (),
  partitionFunctionData_ (::xml_schema::flags (), this),
       ...
       ::xml_schema::flags f)
{
  for (; p.more_elements (); p.next_element ())
  {
    ...
    {
      ::std::auto_ptr< partitionFunctionData_type > r (
        partitionFunctionData_traits::create (i, f, this));

      this->partitionFunctionData_.push_back (r);
      continue;
    }
...
: ::xml_schema::type (),
  ...
  partitionFunctionDataList_ (partitionFunctionDataList, ::xml_schema::flags (), this)
{
}

PartitionFunctionDataFile::
PartitionFunctionDataFile (const massValue_type& massValue,
                           ::std::auto_ptr< partitionFunctionDataList_type >& partitionFunctionDataList)
: ::xml_schema::type (),
  massValue_ (massValue, ::xml_schema::flags (), this),
  partitionFunctionDataList_ (partitionFunctionDataList, ::xml_schema::flags (), this)
{
...
: ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
  massValue_ (f, this),
  partitionFunctionDataList_ (f, this)
{
  if ((f & ::xml_schema::flags::base) == 0)
  {
    ::xsd::cxx::xml::dom::parser< char > p (e, true, false);
                            ...
                            const ::xml_schema::properties& p)
{
  ...
  ::std::auto_ptr< ::PartitionFunctionDataFile > r (
