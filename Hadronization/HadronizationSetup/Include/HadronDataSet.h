...
#ifndef HADRON_DATA_SET_H
#define HADRON_DATA_SET_H
...
class MesonMixingData: public ::xml_schema::type
{
  ...
  void
  mesonFamily (::std::auto_ptr< mesonFamily_type > p);
...
class HadronDataElement: public ::xml_schema::type
{
  ...
  void
  mesonMixingData (::std::auto_ptr< mesonMixingData_type > p);
...
class HadronDataSet: public ::xml_schema::type
{
  ...
  void
  hadronDataList (::std::auto_ptr< hadronDataList_type > p);

  // Constructors.
  //
  HadronDataSet (const hadronDataList_type&);

  HadronDataSet (::std::auto_ptr< hadronDataList_type >&);
