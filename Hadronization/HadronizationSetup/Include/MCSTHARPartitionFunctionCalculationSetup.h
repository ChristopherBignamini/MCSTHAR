...
#ifndef MCSTHARPARTITION_FUNCTION_CALCULATION_SETUP_HXX
#define MCSTHARPARTITION_FUNCTION_CALCULATION_SETUP_HXX
...
class MCSTHARPartitionFunctionCalculationSetup: public ::xml_schema::type
{
  ...
  void
  hadronDataFileName (::std::unique_ptr< hadronDataFileName_type > p);
  ...
  void
  massValueList (::std::unique_ptr< massValueList_type > p);
  ...
  void
  integrationParameters (::std::unique_ptr< integrationParameters_type > p);
  ...
  void
  outputFolder (::std::unique_ptr< outputFolder_type > p);
  ...
  MCSTHARPartitionFunctionCalculationSetup (const hadronDataFileName_type&,
                                            ::std::unique_ptr< chargeConfiguration_type >,
                                            ::std::unique_ptr< microcanonicalParameterGridStructure_type >,
                                            ::std::unique_ptr< massValueList_type >,
                                            ::std::unique_ptr< integrationParameters_type >,
                                            const outputFolder_type&);
...
void
operator<< (::xercesc::DOMElement&, const IntegrationParameters&);

void
operator<< (::xercesc::DOMElement&, const MassValueList&);

// Serialize to std::ostream.
//

void
MCSTHARPartitionFunctionCalculationSetup_ (::std::ostream& os,
                                           const ::MCSTHARPartitionFunctionCalculationSetup& x, 
...
void
MCSTHARPartitionFunctionCalculationSetup_ (::xercesc::XMLFormatTarget& ft,
                                           const ::MCSTHARPartitionFunctionCalculationSetup& x, 
                                           const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                                           const ::std::string& e = "UTF-8",
                                           ::xml_schema::flags f = 0);
...
MCSTHARPartitionFunctionCalculationSetup_ (const ::MCSTHARPartitionFunctionCalculationSetup& x, 
                                           const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                                           ::xml_schema::flags f = 0);

void
operator<< (::xercesc::DOMElement&, const MCSTHARPartitionFunctionCalculationSetup&);
...
#endif // MCSTHARPARTITION_FUNCTION_CALCULATION_SETUP_HXX
